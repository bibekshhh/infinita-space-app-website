            ...
            <Container id="problem-statements" className="mt-10">
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10 mt-[-30px]">
                    ...
                    <div class="flex items-center gap-x-4 mb-3">
                        <div class="inline-flex justify-center items-center w-[62px] h-[62px] rounded-full border-4  border-blue-50 bg-blue-100 border-bg-slate-200 dark:bg-transparent">
                        <svg class="w-6 h-6 text-blue-600 dark:text-[#DD210A]" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
