                    ...
                    <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-[#161c26] dark:border-gray-800" href="https://www.spaceappschallenge.org/resources/">
                        <div class="p-4 md:p-5">
                            <div class="flex">
                                ...
                                <div class="grow ml-5">
                                    <h3 class="group-hover:text-blue-600 font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                                        Get help in the official site
                                    </h3>
                                    <p class="text-sm text-gray-500">
                                        Just head to «Resources» section
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex">
                                ...
                                <div class="grow ml-5">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Reach us at <span class="text-blue-600 font-medium dark:text-blue-500">infinita.org@gmail.com</span>
                                    </p>
                                </div>
                            </div>
                        </div>
